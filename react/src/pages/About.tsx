  ...
  return (
    <Layout>
      ...
      <p className="text-black max-w-3xl mx-auto">
        ...
        bajo costo que afectan negativamente a nuestros agricultores locales y a
        ...
        directamente a los agricultores con los consumidores finales. Eliminamos
        los intermediarios, promoviendo una economía local más justa y
        equitativa.
        <br />
        <br />
      ...
      <section className="my-8">
        ...
        <div className="flex justify-between mx-8">
          ...
          <div className="text-center flex-1 mx-4">
            ...
            <p className="text-black mt-2">
              Buscamos constantemente mejorar y adaptarnos a nuevas tecnologías.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="my-8 text-center">
        ...
        <p className="text-black max-w-3xl mx-auto mb-4">
          ¿Te interesa lo que hacemos? ¡Únete a nuestra comunidad! Suscríbete a
          nuestro boletín para recibir las últimas noticias, ofertas exclusivas,
          y mucho más.
        </p>
