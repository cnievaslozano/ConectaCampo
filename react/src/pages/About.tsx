  ...
  return (
    <Layout>
      <div className="bg-lightGreen3 text-black font-sans">
        <main className="bg-white text-center max-w-5xl mx-auto my-8 py-16 px-4 shadow-lg rounded-lg">
          <h1 className="text-4xl font-serif font-bold text-2d572c mb-4 text-center text-[#006400]">
            Sobre Nosotros
          </h1>
          <p className="text-black max-w-3xl mx-auto">
            Somos tres estudiantes apasionados por la informática y
            comprometidos con el desarrollo sostenible y la justicia económica.
            Nos hemos enfrentado a la creciente problemática de los productos
            importados de bajo costo que afectan negativamente a nuestros
            agricultores locales y a la economía regional.
            <br />
            <br />
            Con la firme convicción de que es posible cambiar esta realidad,
            hemos decidido poner en marcha una plataforma web innovadora que
            conecta directamente a los agricultores con los consumidores
            finales. Eliminamos los intermediarios, promoviendo una economía
            local más justa y equitativa.
            <br />
            <br />
          ...
          <section className="flex flex-wrap justify-around mt-4">
            <div className="flex-1 max-w-xs mx-2">
              ...
              <p className="text-black mt-2">
                ...
                sostenibles. Nos comprometemos a proporcionar una plataforma
                donde los agricultores puedan vender directamente a los
                consumidores, asegurando precios justos y reduciendo los costos
                adicionales impuestos por los intermediarios.
              </p>
            </div>
            <div className="flex-1 max-w-xs mx-2">
              <h2 className="text-2xl font-serif font-bold text-2d572c text-[#006400]">
              ...
              <p className="text-black mt-2">
                Nuestra visión es ser el puente entre agricultores y
                consumidores, facilitando un comercio justo y local. Aspiramos a
                crear una comunidad conectada donde los consumidores puedan
                acceder a productos frescos y de alta calidad, mientras apoyan a
                los agricultores locales y contribuyen a una economía más
                sostenible.
              </p>
            </div>
          </section>
          ...
          <section className="my-8 text-center">
            ...
            <p className="text-black max-w-3xl mx-auto mb-4">
              ¿Te interesa lo que hacemos? ¡Únete a nuestra comunidad!
              Suscríbete a nuestro boletín para recibir las últimas noticias,
              ofertas exclusivas, y mucho más.
            </p>
