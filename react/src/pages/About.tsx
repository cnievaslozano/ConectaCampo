        ...
        <div className="bg-white text-black font-sans">
            ...
            <main className="bg-white p-4 text-center max-w-5xl mx-auto my-8 shadow-lg rounded-lg">
                ...
                <section className="flex flex-wrap justify-around mt-4">
                    ...
                    <div className="flex-1 max-w-xs mx-2">
                        <h2 className="text-2xl font-serif font-bold text-2d572c text-[#006400]">Nuestra Visión</h2>
                        <p className="text-black mt-2">
                ...
                <section className="my-8">
                    ...
                    <div className="flex justify-between mx-8">
                        <div className="text-center flex-1 mx-4">
                            <img src={ValueImage1} alt="Sostenibilidad" className="w-32 h-auto mb-2 mx-auto" />
                            <p className="text-black font-semibold">Sostenibilidad</p>
                            <p className="text-black mt-2">Promovemos prácticas que respeten el medio ambiente.</p>
                        </div>
                        <div className="text-center flex-1 mx-4">
                            <img src={ValueImage2} alt="Transparencia" className="w-32 h-auto mb-2 mx-auto" />
                            <p className="text-black font-semibold">Transparencia</p>
                            <p className="text-black mt-2">Creemos en una comunicación abierta y honesta.</p>
                        </div>
                        <div className="text-center flex-1 mx-4">
                            <img src={ValueImage3} alt="Justicia Económica" className="w-32 h-auto mb-2 mx-auto" />
                            <p className="text-black font-semibold">Justicia Económica</p>
                            <p className="text-black mt-2">Nos esforzamos por garantizar un comercio justo para todos.</p>
                        </div>
                        <div className="text-center flex-1 mx-4">
                            <img src={ValueImage4} alt="Innovación" className="w-32 h-auto mb-2 mx-auto" />
                            <p className="text-black font-semibold">Innovación</p>
                            <p className="text-black mt-2">Buscamos constantemente mejorar y adaptarnos a nuevas tecnologías.</p>
                        </div>
                    </div>
                </section>
                ...
                <section className="my-8 text-center">
                    ...
                    <p className="text-black max-w-3xl mx-auto mb-4">
                        ¿Te interesa lo que hacemos? ¡Únete a nuestra comunidad! Suscríbete a nuestro boletín para recibir las últimas noticias, ofertas exclusivas, y mucho más.
                    </p>
